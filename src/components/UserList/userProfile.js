                ...
                <div>
                    ...
                    <div>
                        <Row>
                            ...
                            <Label className="smallText">User permissions can be sent via <a href="google.com">User Access</a>. </Label><br/>
                            </Col>
                            <Col xs="3">
                            <Col >
                             <img src="" style={{width:"15%",height:"15%"}} onClick={this.handleCreateuser}/> 
                            {/* </Col>
                            <Col> */}
                            <Label style={{color:"#76A2F6",marginLeft:"10px"}} onClick={this.handleCreateuser}>Create New User</Label>
                            </Col>
                    ...
                    <Row>
                        ...
                        <Col>
                        <img src="" style={{width:"10%",height:"45%"}}/>                            
